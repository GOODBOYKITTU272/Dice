...
DELIVERY_BOARD = [
    ...
    ("Phase 4D — Question Engine", "IN PROGRESS — RADIO/TEXTAREA extraction built from live evidence; select/date/checkbox/multi-select not yet observed"),
...
BROWSER_STATUS = [
    ...
    ("No-question branch (NO_QUESTIONS_PRESENT)", "VERIFIED"),
    ("Radiogroup extraction", "BUILT FROM LIVE EVIDENCE — offline-verified"),
    ("Textarea extraction", "BUILT FROM LIVE EVIDENCE — offline-verified"),
    ("NEEDS_INPUT classification", "BUILT FROM LIVE EVIDENCE — offline-verified"),
